...
public class Welcome {
	...
	public static void main(String[] args) {// TODO Auto-generated method stub
		...
		String greeting = "Weclome to Shopping Mall"; // 인사말을 문자열 변수에 저
		String tagline = "Weclome to Book Market!";
				...
				if (n<1||n>9) {
					...
					switch(n) {
					  case 1:
						  ...
						  //System.out.format("연락처: %011d\r", userMobile);
	...
	public static void menuGuestInfo(String name, int mobile) {
		...
		//System.out.format("연락처 : %011d\r", mobile);
		System.out.print("이름 "+ mUser.getName()+"  연락처 ");
		System.out.format("%011d\n", mobile);
		System.out.print("\r");
	}
			...
			if (flag) {
				...
				if (str.toUpperCase().equals("Y")) {
					...
					if (!isCartInBook(booklist.get(numId).getBookId())) {
						...
						//mCartItem[mCartCount++] = new CartItemBook(boolist[numId]);
	...
	public static void menuCartBill() throws CartException{
		...
		if(mCart.mCartCount == 0)
			...
			if(str.toUpperCase().equals("Y")) {
				...
				System.out.print("배송 받을 고객명을 입력하세요 ");
				String name = input.nextLine();
				System.out.print("배송 받을 고객의 연락처를 입력하세요 ");
				String phone = input.nextLine();
				System.out.print("배송 받을 고객의 배송지를 입력해주세요 ");
				String address = input.nextLine();
